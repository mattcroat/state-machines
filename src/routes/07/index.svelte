<script>
  ...
  onMount(() => {
    ...
    const isAuthorized = (context, state) => {
      return !!context.user
    }
    ...
    const service = interpret(createDragDropMachine({ name: 'Matia' }), {
      devTools: true,
    })
...
<h1>Exercise 07 - Transient Transitions</h1>
